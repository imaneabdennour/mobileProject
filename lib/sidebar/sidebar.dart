                  ...
                  child: Column(
                    children: <Widget>[
                      ...
                      MenuItem(
                        ...
                        onTap: () {
                          onIconPressed();
                          BlocProvider.of<NavigationBloc>(context).add(NavigationEvents.StatisticClickedEvent);
                        },
                      ),
                      MenuItem(
                        icon: Icons.feedback,
                        ...
                        onTap: (){
                          onIconPressed();
                          BlocProvider.of<NavigationBloc>(context).add(NavigationEvents.QuizClickedEvent);
                        },
                      ),
                      MenuItem(
                        ...
                        onTap: (){
                          onIconPressed();
                          BlocProvider.of<NavigationBloc>(context).add(NavigationEvents.ConseilClickedEvent);
                        },
                      ),
                      Divider(
                        height: 30,//64,
