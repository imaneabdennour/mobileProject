...
class _QuizState extends State<Quiz> {
  ...
  void initState() {
    ...
    if(percentage >= 90){
      message = "Vous devez visiter le medecin le plus tot possible !";
    }else if (percentage > 50 && percentage < 70){
      message = "7di rassek ! 3awd dowz test kola nhar !";
    }else if (percentage < 30){
      message = "rah mafik walo !";
    }
  ...
  "title": "Ces dernières 48 heures, est-ce-que votre température était plus élevée que 37 ?",
    "explication": "La température se mesure avec un thermomètre.\nLe thermomètre indique un nombre,\nc'est la température de votre corps.",
  "answers": [
...
"title": "Ces derniers jours, avez-vous noté une forte diminution ou perte de votre goût ou de votre odorat ?",
  "explication": " La perte du goût, c'est quand vous ne pouvez plus reconnaître le\ngoût d'un aliment.\nPar exemple, le poulet a le même goût que le poisson.\n\nLa perte de l'odorat, c'est quand vous ne sentez plus les odeurs.Par exemple, vous ne pouvez plus sentir l'odeur du poulet qui sort du four.",
...
"title": "Avez-vous de l’hypertension artérielle mal équilibrée ?\n Ou avez-vous une maladie cardiaque ou vasculaire ? \n Ou prenez vous un traitement à visée cardiologique ?",
  "explication": "Une hypertension artérielle mal équilibrée, c'est une augmentation importante de la tension artérielle.\n Sa augmentation peut entraîner des maladies cardiaques ou vasculaires: maladies du cœur.\nCette maladie nécessite un traitement qu'on appelle traitement cardiologique.",
"answers": [
{"answer": "Oui", "correct": true},
{"answer": "Non", "correct": false},
...
"title": "Avez-vous une maladie respiratoire ? \n Ou êtes-vous suivi par un pneumologue ?",
  "explication": "Une maladie respiratoire, c'est une maladie qui empêche de bien respirer. Cette maladie touche les organes qui sont nécessaires pour la respiration comme les poumons.\nUn pneumologue, c'est le médecin des poumons, et des maladies liées aux poumons. Quand on a une maladie respiratoire, on va voir le pneumologue.",
"answers": [
{"answer": "Oui", "correct": true},
{"answer": "Non", "correct": false},
          ...
          Container(
                decoration: BoxDecoration(
                    gradient: LinearGradient(
                        ...
                        colors:  [Colors.blue, Color(0xffb7e4c7)])),
            child: ListView(
              ...
              children: <Widget>[
                    ...
                    child:Row(
                      children: <Widget>[
                          ...
                          Text(
                            ...
                            style: TextStyle(color: Color(0xff143642),
                ...
                ListTile(
                  ...
                  title: Padding(
                    ...
                    child: Text(
                      ...
                      style:
                      TextStyle(fontSize: 22,fontWeight: FontWeight.bold, color : Color(0xff143642)),
                ...
                ListTile(
                  title: Padding(
                      ...
                      decoration: BoxDecoration(
                      borderRadius: BorderRadius.circular(24),
                      border: Border.all(color: Color(0xff143642), width: 2)
                      ),
                        child: Padding(
                          ...
                          child: Text(
                            ...
                            style:
                            TextStyle(
                              fontSize: 18, /*fontWeight: FontWeight.bold,*/ color : Color(0xff143642),
                            ),
                            textAlign : TextAlign.justify,
                          ),
                        ),
                            ...
                            child: Container(
                                ...
                                padding: const EdgeInsets.all(10.0),
                                  ...
                                  child: RaisedButton(
                                    ...
                                    child: Text(
                                      answer['answer'],
                                      style: TextStyle(fontSize: 22, color: Color(0xff143642)),
